...
import { Carrito, GuitarraResponse } from '../interfaces';

const props = defineProps<{
  carrito: Carrito[],
  guitarra: GuitarraResponse
}>()


defineEmits<{
  'decrementar-cantidad': [id: number],
  'incrementar-cantidad': [id: number],
  "agregar-carrito": [guitarra: GuitarraResponse],
  'eliminar-producto-carrito': [id: number]
  'vaciar-carrito': [],
}>()
                    ...
                    <tr v-for="producto in carrito">
                      ...
                      <td>
                        <button class="btn btn-danger" type="button"
                          @click="$emit('eliminar-producto-carrito', producto.id)">
                          X
                        </button>
                      </td>
                    </tr>
